...
enum ElementType: String {
    ...
    var image: Image {
        switch self {
        case .grass:
            return Image("ImageGrass")
        case .poison:
            return Image("ImagePoison")
        case .fire:
            return Image("ImageFire")
        case .flying:
            return Image("ImageFlying")
        case .water:
            return Image("ImageWater")
        case .bug:
            return Image("ImageBug")
        case .normal:
            return Image("ImageNormal")
        case .electric:
            return Image("ImageElectric")
        case .ground:
            return Image("ImageGround")
        case .fairy:
            return Image("ImageFairy")
        case .psychic:
            return Image("ImagePsychic")
        case .rock:
            return Image("ImageRock")
        case .ice:
            return Image("ImageIce")
        case .dragon:
            return Image("ImageDragon")
        case .dark:
            return Image("ImageDark")
        case .steel:
            return Image("ImageSteel")
        case .fighting:
            return Image("ImageFighting")
        case .ghost:
            return Image("ImageGhost")
        }
    }
